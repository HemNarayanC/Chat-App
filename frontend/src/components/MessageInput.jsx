        ...
        <div className='p-4 w-full'>
            {imagePreview && (
                <div className="mb-3 flex items-center gap-2">
                    <div className="relative">
                        ...
                        <buttoon className="absolute -top-1 5 -right-1 5 w-5 h-5 rounded-full bg-base-300 flex items-center justify-center">
                            <X className='size-3' />
                        </buttoon>
                    </div>
                </div>
            ...
            <form action="" onSubmit={handleSendMessage} className='flex items-center gap-2'>
                <div className="flex-1 flex gap-2">
                    ...
                    <input type="file" placeholder='Type a message' accept='image/*' onChange={handleImageChange} className="hidden" ref={fileInputRef} />
